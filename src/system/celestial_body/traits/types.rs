...
pub enum TelluricOceanComposition {
    Hydrogen,
    Neon,
    Oxygen,
    Nitrogen,
...
impl Display for TelluricOceanComposition {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match self {
            TelluricOceanComposition::Hydrogen => write!(f, "Hydrogen"),
            TelluricOceanComposition::Neon => write!(f, "Neon"),
            TelluricOceanComposition::Oxygen => write!(f, "Oxygen"),
            TelluricOceanComposition::Nitrogen => write!(f, "Nitrogen"),
            TelluricOceanComposition::CarbonMonoxyde => write!(f, "Carbon Monoxyde"),
            TelluricOceanComposition::Methane => write!(f, "Methane"),
            TelluricOceanComposition::Ammonia => write!(f, "Ammonia"),
            TelluricOceanComposition::SulfurDioxyde => write!(f, "Sulfur Dioxyde"),
            TelluricOceanComposition::Water => write!(f, "Water"),
            TelluricOceanComposition::Lead => write!(f, "Lead"),
            TelluricOceanComposition::Rock => write!(f, "Rock"),
            TelluricOceanComposition::Metal => write!(f, "Metal"),
        }
    }
}
