...
impl StarSystem {
    ...
    pub fn new(all_objects: Vec<OrbitalPoint>, center_point_id: u32, main_star_id: u32) -> Self {
        Self {
            center: center_point_id,
            main_star: main_star_id,
            all_objects,
        }
    }
    ...
    pub fn get_main_star_mut(&mut self) -> &mut OrbitalPoint {
        self.get_point_mut(self.main_star)
            .expect("There should always be a main star.")
    }
